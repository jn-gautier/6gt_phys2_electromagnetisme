...
\begin{figure}[h!]
    ...
    {\input{./tikz/ar_aimants_droits.tikz}}
...
\begin{figure}[!ht]
    ...
    \begin{minipage}[b]{.67\linewidth}
        \centering
        \includegraphics[width=.9\linewidth]{spectre_aimant_droit.png}
        \caption{Spectre magnétique d'un aimant droit.}
        \label{spectre_aimant_droit}
    \end{minipage}
    \begin{minipage}[b]{.27\linewidth}
        \centering
        \includegraphics[width=.9\linewidth]{spectre_aimant_U.png}
